...
%   20 Jan 2021 (CvdT) Include PROSPECT-PRO coefficients. The fluorescence
%                       excitation- emission matrix is re-calibrated to 
%                       produce photon-photon instead of energy-energy
% usage:
